/**
 * Componente FloatingCTA - Botão flutuante de WhatsApp
 * Sempre visível para fácil acesso ao agendamento
 */
...
export function FloatingCTA() {
  ...
  useEffect(() => {
    // Mostrar botão após scroll inicial
    const handleScroll = () => {
      setIsVisible(window.scrollY > 100);
    };

    // Mostrar após um pequeno delay também
